...
for (let i = 1; i < 16; i++) {
    ...
    console.log('Pelna tablica numer ', i, ' ', arraytoadd)
    let maxNumber = (Math.max(...arraytoadd))
    console.log('maksymalny numer ' + maxNumber)
    maxDigitsSum = maxDigitsSum + maxNumber
    console.log('dodaje numer ' + maxNumber + ' do wyniku ogolnego ' + maxDigitsSum)
    arraytoadd = []
    h = h + i
    j = j + i + 1
}
console.log(maxDigitsSum)